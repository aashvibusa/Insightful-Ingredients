...
import com.example.barcodescannerapp.MainActivity
...
class ListActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.example.barcodescannerapp.R.layout.activity_list)

        var listView = findViewById<ListView>(com.example.barcodescannerapp.R.id.listView)
